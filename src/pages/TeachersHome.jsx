  ...
  return (
    <div className="p-8 bg-[#FFFCEF] h-screen flex flex-col">
      ...
      <div className="flex gap-6 min-h-0 flex-1">
        {/* Groups Table */}
        <div className="flex-1 bg-white rounded-2xl border border-[#5C899D]/15 shadow-[0_4px_32px_rgba(92,137,157,0.08)] overflow-hidden flex flex-col min-h-0">
          ...
          >
            ...
            <div className="flex gap-3 p-6 pb-4">
              ...
              <div className="flex-1 bg-[#FFFCEF] rounded-xl px-4 py-3 border border-[#5C899D]/10">
                ...
                <p className="text-[15px] font-medium text-[#2e5a6e]">
                  {teacherStudents.filter((s) => s.group?._id === selectedGroup._id).length}
                </p>
              </div>
            </div>
